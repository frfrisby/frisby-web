...
// intentionally a class — consistent with all other Default* implementations; constructor validation + List.copyOf() is cleaner than a compact record constructor
