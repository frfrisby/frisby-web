 ...
 * {@code SseMessage<T>} whose {@link #body()} is the deserialized payload; {@code String}-body handlers
...
public interface SseMessage<T> {
     ...
     * {@code data} string via the client's configured {@code JsonSerializer}. For a
     * {@code String}-body handler, this is the untouched wire-format {@code data} string itself
